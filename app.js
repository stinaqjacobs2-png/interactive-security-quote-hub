...
function renderCostRequests() {
  ...
  return `<div class="cost-request-page"><div class="cost-request-page-heading"><h2>Purchase Order Requests</h2><p>Submit supplier quotations and supporting information for purchase order processing.</p></div><section class="cost-request-upload-hero"><div><p class="eyebrow">Request upload</p><h3>Upload a purchase request with supplier documents</h3><p>Capture the supplier, entity, line items and required date, then attach the quotation, invoice or supporting records finance needs to process the request.</p></div><div class="cost-upload-checks"><span>Supplier quotation</span><span>Invoice or PO</span><span>Supporting files</span></div><a class="primary-btn" href="#costRequestEntry">Upload Request</a></section><section class="finance-card cost-request-new-panel" id="costRequestEntry"><div class="panel-heading"><div><h3>Upload Request</h3><p class="finance-note">Complete the request details and upload every required document before submitting.</p></div></div><form class="cost-form-grid cost-request-entry-form" data-cost-form="request">
    ...
    <div class="cost-form-wide cost-request-upload-box"><div class="panel-heading"><div><p class="eyebrow">Document upload</p><h3>Upload request documents</h3><p>Attach supplier quotations, invoices, purchase orders, contracts, spreadsheets or supporting images.</p></div></div><label class="cost-upload-dropzone">Request documents<input name="files" type="file" multiple accept=".pdf,.doc,.docx,.xls,.xlsx,.csv,.png,.jpg,.jpeg" /><small>Accepted: PDF, Word, Excel, CSV, PNG and JPG files.</small></label></div><label class="cost-form-wide">Notes<textarea name="notes" rows="3"></textarea></label><button class="primary-btn cost-request-submit" type="submit">Submit purchase request</button></form></section>
